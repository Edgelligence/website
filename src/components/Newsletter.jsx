...
function Newsletter() {
  ...
  const getButtonClass = () => {
    const baseClass = "px-6 py-2 font-semibold rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-white dark:focus:ring-offset-gray-900 text-sm";
  ...
  return (
    <section className="w-full max-w-md mx-auto px-4 py-4 md:py-5">
